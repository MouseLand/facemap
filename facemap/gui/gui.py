...
class MainW(QtWidgets.QMainWindow):
    ...
    def make_buttons(self):
        ...
        self.load_trace1_button.clicked.connect(
            lambda: self.load_trace_button_clicked(1)
        )
        ...
        self.load_trace2_button.clicked.connect(
            lambda: self.load_trace_button_clicked(2)
        )
            ...
            if data.ndim == 1:
                ...
                if dialog.exec_():
                    ...
                    if plot_id == 1:
                        ...
                        self.trace1_legend.setPos(
                            self.trace1_plot.x(), self.trace1_plot.y()
                        )
                        ...
                        self.trace2_legend.setPos(
                            self.trace2_plot.x(), self.trace2_plot.y()
                        )
