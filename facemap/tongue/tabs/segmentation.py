...
class SegmentationTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.video_view_group = QButtonGroup(button_widget)
        ...
        video_label_widget = QWidget()
        video_label_layout = QVBoxLayout(video_label_widget)
        video_label_layout.setContentsMargins(0, 0, 0, 0)

        loaded_videos_label = QLabel("No Videos Loaded")
        loaded_videos_label.setStyleSheet("color: lightgrey;")
        loaded_videos_label.setAlignment(Qt.AlignCenter)
        video_label_layout.addWidget(loaded_videos_label)

        # Add the panels to the splitter
        splitter.addWidget(button_widget)
        splitter.addWidget(video_label_widget)
