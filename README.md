...
If you are just getting started, I recommend trying out the python version. The GUI is much nicer to use, and it allows you to inspect the processed data. You can save the output file as a matlab file with a checkbox in the GUI.
...
For 2p imaging, you'll need a tighter filter around 850nm so you don't see the laser shining through the mouse's eye/head, for example [this](https://www.thorlabs.de/thorproduct.cfm?partnumber=FB850-40). Depending on your lenses you'll need to figure out the right adapter(s) for such a filter. For our 10x lens above, you might need all of these adapters ([1](https://www.edmundoptics.com/optics/optical-filters/optical-filter-accessories/M52-to-M46-Filter-Thread-Adapter/), [2](https://www.thorlabs.de/thorproduct.cfm?partnumber=SM2A53), [3](https://www.thorlabs.de/thorproduct.cfm?partnumber=SM2A6), [4](https://www.thorlabs.de/thorproduct.cfm?partnumber=SM1L03)
